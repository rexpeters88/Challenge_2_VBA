...
Sub QuarterlyStockAnalysis_AllSheets()
    ...
    For Each ws In ThisWorkbook.Sheets(sheetNames)
        ...
        maxIncrease = -999999 'arbitratry negative value all increases will be larger than
        maxDecrease = 999999 'arbitratry positive value all increases will be larger than
        maxVolume = 0
        ...
        For i = 2 To lastRow
            ...
            ' Total volume for opening to close of current ticker
